...
class McpServer
{
    ...
    private function instructions(): string
    {
        return implode("\n", [
            ...
            '- A decision you have settled (a library, approach, or tradeoff) → log_decision (pass supersedes to replace an earlier one).',
            '- A dead-end ruled out, a gotcha, or where you left off → add_thread_entry (typed: dead_end/gotcha/momentum).',
