...
class WrapUpPrompt extends Prompt
{
    ...
    public function messages(): array
    {
        ...
        3. For anything worth remembering next session: a decision you settled → call log_decision with the decision and the WHY (pass supersedes with an earlier decision's id if this replaces it); a dead-end ruled out, a gotcha, or where you left off and what's next → call add_thread_entry with the right type (dead_end / gotcha / momentum). Breadcrumb the originating task with task_id when there is one.
